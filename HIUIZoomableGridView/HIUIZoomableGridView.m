...
- (void)_layoutTileAtIndexPath:(NSIndexPath*)indexPath {
    ...
    if ( [self.dataSource respondsToSelector:@selector(gridView:willShowTile:atIndexPath:)] ) {
        [self.dataSource gridView:self willShowTile:item.tile atIndexPath:indexPath];
    }
}
